# To run the MLP regressor, use this file with optuna for training
...
def run_model(model_name, objective_fn, model_class):
    ...
    final_model = make_estimator(model_class, best_params)
    final_model.fit(X, y)
    ...
    # ======= PLOT LOO CV =======
    plot_predictions(actuals, predictions, mae, rmse, r2, model_name=model_name)
